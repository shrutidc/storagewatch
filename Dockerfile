...
# Handed to Macs by /install.sh, /uninstall.sh and /collector.py, so nobody needs the repo.
COPY collector/collector.py collector/install.sh collector/uninstall.sh ./collector/
